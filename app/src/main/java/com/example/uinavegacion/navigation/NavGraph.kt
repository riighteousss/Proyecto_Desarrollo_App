...
fun AppNavGraph(navController: NavHostController,
                ...
                serviceViewModel: ServiceViewModel) { // Recibe el controlador
        ...
        Scaffold( // Estructura base de pantalla
            ...
            NavHost( // Contenedor de destinos navegables
                ...
                composable(Route.Emergency.path) {
                    EmergencyScreen(onSent = { navController.navigate(Route.Mechanics.path) }, serviceViewModel = serviceViewModel)
                }
